  ...
  return (
    <div className="px-4 py-6 space-y-8">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div id={id} className="space-x-2">
          {priority && (
            <span className="bg-red-500 rounded-full px-3 py-1 text-sm font-semibold uppercase text-red-50 tracking-wide">
              Priority
            </span>
          )}
          <span className="bg-green-500 rounded-full px-3 py-1 text-sm font-semibold uppercase text-red-50 tracking-wide">
            {status} {cart.length} order
          </span>
        </div>
      </div>
